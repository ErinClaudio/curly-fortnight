...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<rubocop>.freeze, ["= 1.10.0"])
    s.add_runtime_dependency(%q<rubocop-performance>.freeze, ["= 1.9.2"])
  else
    s.add_dependency(%q<rubocop>.freeze, ["= 1.10.0"])
    s.add_dependency(%q<rubocop-performance>.freeze, ["= 1.9.2"])
  end
end
